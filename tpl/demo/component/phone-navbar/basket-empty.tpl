...
<div class="lui_phone_navbar_overlay opened" data-target="basket">
	<div class="empty_basket fa_b_shopping-basket">
		...
		<div class="actions">
			<div class="lui_button primary">View products</div>
		</div>
		<div class="spacer">
			or you can
		</div>
		<div class="actions">
			<div class="lui_button secondary">Log into your account</div>
		</div>
	</div>
</div>
...
<div class="lui_phone_navbar">
	...
	<a class="active" data-target="basket">
		<div class="fa_b_shopping-basket">Basket</div>
	</a>
</div>
